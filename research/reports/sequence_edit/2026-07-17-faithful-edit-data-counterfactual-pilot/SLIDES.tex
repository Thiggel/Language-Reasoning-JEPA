...
\begin{frame}{The next pilot varies one data axis at a time}
  \begin{itemize}
    ...
    \item The admitted counterfactual curve uses K=0, 1, and 4 exact alternative outcomes at the common 2,000-trajectory anchor.
    ...
    \item K=8 is implemented but gated because seven cells exceeded the sequence-edit 16 GPU-hour round limit.
