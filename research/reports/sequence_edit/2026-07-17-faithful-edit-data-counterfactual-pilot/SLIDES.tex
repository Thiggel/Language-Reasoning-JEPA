...
\begin{frame}{One-token effects disappear in the global target}
  \begin{itemize}
    ...
    \item We screen coefficients .25, 1, and 4, plus a lower-learning-rate check at the high coefficient.
  \end{itemize}
  \vfill
  \textbf{Next decision:} continue only if the correct action beats persistence, shuffled actions, and chance assignment without rank collapse.
\end{frame}
\end{document}
