...
| deferred (sequence edit) | Can a token-aligned recursive state pass causal fixtures that pooled and step-attention states failed? | Whether a future sequence-edit cycle should restart at all. | CPU-scale exact-edit fixture with shuffled-action, persistence, assignment, and recursive-consistency gates before GPU work. |
