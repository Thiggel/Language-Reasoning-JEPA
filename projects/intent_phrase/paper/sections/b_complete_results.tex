...
\begin{table}[h]
\caption{One-seed mechanism controls. These rows are exploratory. Raw distance uses an oracle-terminal embedding and is candidate privileged. GAR names the supervision. TV and direct name the scoring factorization.}
\label{tab:mechanism}
\centering
\small
\begin{tabular}{lcc}
...
Test-time FLOP scaling & invalid pilot & \todoresult & \todoresult & \todoresult \\
\bottomrule
\end{tabular}
\end{table}
