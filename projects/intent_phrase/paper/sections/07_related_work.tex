...
The overlap changes the novelty claim. This is not the first JEPA planner and not the first planning-aware latent geometry. The contribution is the action-level counterfactual formulation, its control-sufficiency account, and a controlled comparison of predictive and direct candidate scoring in language.
