...
The latest audit found stochastic dropout in the base EMA target and an
incorrect coordinate comparison in prior shooting. The active correction
cycle removes both confounds and tests hard prior/codebook-supported planning.
