...
\midrule
\texttt{champion\_cal} & scalar + ranking & 0.910 & 0.995\\
\textbf{\texttt{mono\_distill\_rank}} & \textbf{binary only}
 & \textbf{0.935} & 0.990\\
\texttt{mono\_hi} & scalar regression & 0.655 & 0.935\\
\texttt{mono\_distill} & binary (no ranking) & 0.530 & 0.885\\
\texttt{mono\_lf\_distill} & \emph{none} (all-steps hinge) & 0.355 & 0.775\\
\texttt{geometric} & \emph{none} (curvature) & 0.300 & 0.715\\
\texttt{distill\_v} & none, \emph{unshaped} (control) & 0.190 & 0.640\\
\bottomrule
\end{tabular}
