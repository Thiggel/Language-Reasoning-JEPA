...
\begin{itemize}\itemsep2pt
  ...
  \item \textbf{Unobserved actions --- first results}: variational
        $q(a\mid s_{t-1},s_t)$, prior sampling planner, detached
        intent-decode readout. v1 posterior-collapses; free bits (4 nats)
        reach 0.195/0.68 --- $\approx$22\%/70\% of the observed-action
        ceiling. Open frontier: code-taxonomy probes, ranking in code
        space.
