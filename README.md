...
> distance a usable planning energy, and probes characterize the state as a
> recency-weighted working memory over an objective-independent relational
> scaffold — with no anticipatory answer computation.
